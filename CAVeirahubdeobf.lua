...
KeySystemUI.New({
    ...
    DiscordInvite = "https://discord.com/invite/Vpv657ZThG", -- Optional.
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Powerblack09yt/Scripts/main/autofarmchest.lua"))()
    end
})
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "assetirbxd://9945562382"
...
warn("CAVEIRA Hub Loading Completed !!")

local Webhook_URL = "https://discord.com/api/webhooks/1181043861062160424/HGd4mKynNvtYjO--CpSv-e9XaidlzzVbtIZXxI20JtntWQg31nNMZHjrbilEqDDZX4UV"
local Headers = {
...
local data = {
    ["embeds"] = {
        {
            ["title"] = "Someone executed blox fruits loader",
