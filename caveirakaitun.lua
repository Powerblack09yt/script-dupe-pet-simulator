...
if _G.Switch_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Caveira Hub"].Level
		game:GetService("CoreGui")["Caveira Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Caveira Hub"].Level.Fragments.Text = "Caveira Hub"
		game:GetService("CoreGui")["Caveira Hub"].Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
		game:GetService("CoreGui")["Caveira Hub"].Level.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Level.Position = UDim2.new(0.5, 0, -0.2, 0)
		game:GetService("CoreGui")["Caveira Hub"].Level.Fragments.TextStrokeTransparency = 1
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Caveira Hub"].Text2
		game:GetService("CoreGui")["Caveira Hub"].Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Caveira Hub"].Text2.Fragments.Text = ""
		game:GetService("CoreGui")["Caveira Hub"].Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Caveira Hub"].Text2.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text2.Fragments.TextStrokeTransparency = 1
		...
		game:GetService("CoreGui")["Caveira Hub"].Text.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Caveira Hub"].Text.Fragments.Text = '( '..game.Players.LocalPlayer.Name..' )'
		game:GetService("CoreGui")["Caveira Hub"].Text.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Caveira Hub"].Text.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text.Position = UDim2.new(0.5, 0, 0.14, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text.Fragments.TextStrokeTransparency = 1
		-- Status
		...
		game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.Text = 'Status: Farm Level.'
		game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.Size = UDim2.new(1, 0, 0, 28)
		game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text3.Position = UDim2.new(0.5, 0, 0.22, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.TextStrokeTransparency = 1
		-- Item Sanguine Art
		...
		game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.Text = '...'
		game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text5.Position = UDim2.new(0.5, 0, 0.38, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.TextStrokeTransparency = 1
		-- Full Moon
		...
		game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.TextColor3 = Color3.fromRGB(255,140,0)
		game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
		game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text6.Position = UDim2.new(0.5, 0, -0.03, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.TextStrokeTransparency = 1
		spawn(function()
			while wait(1) do
				pcall(function()
					if Three_World then
						if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
							game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 100% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
							game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
							game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 50% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
							game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 25% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
							game:GetService("CoreGui")["Caveira Hub"].Text6.Fragments.Text = '🌕 15% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						else 
		...
		game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.Text = '...'
		game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.Size = UDim2.new(1, 0, 0, 35)
		game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Caveira Hub"].Text4.Position = UDim2.new(0.5, 0, 0.47, 0)
		game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.TextStrokeTransparency = 1
		...
		Uitoggle.Text = "Caveira Hub Kaitun"
		...
		if game.CoreGui:FindFirstChild('Caveira Hub C') then
			game.CoreGui:FindFirstChild('Caveira Hub C'):Destroy()
		end
		local function click(a)
		...
		uig.Parent = game:GetService("CoreGui")["Caveira Hub C"].FruitB
		...
		game:GetService("CoreGui")["Caveira Hub C"].FruitB.Visible = true
		click(game:GetService("Players").LocalPlayer.PlayerGui.Main.MenuButton) -- open menu
		]]
		wait(.5)
		...
		function Set_Status_X(vu)
			game:GetService("CoreGui")["Caveira Hub"].Text3.Fragments.Text = vu
		end
		--[[
		...
		Notify({
			...
			Title = "Caveira Hub Kaitun | "..tostring(game.Players.LocalPlayer.Name),
			Duration = 5
		})
		Notify({
		...
		_G.library = loadstring(game:HttpGet(""))()
		library = _G.library
	end
	...
	CheckMonSpawn = {}
	function Click()
		local Module = require(game:GetService("ReplicatedStorage").Controllers.CombatController)
		...
		while wait(10) do
			pcall(function()
				...
				if ris_text ~= '' then
					...
					game:GetService("CoreGui")["Caveira Hub"].Text4.Fragments.Text  = ris_text
				end
				local ris_text = ''
				if RGB_H then
					ris_text = 'RGB Aura'
				...
				game:GetService("CoreGui")["Caveira Hub"].Text5.Fragments.Text = ris_text
				wait(300)
			end)
		end
	end)
					...
					if Three_World then
						...
						if game.Workspace.Enemies:FindFirstChild('rip_indra True Form') or game.ReplicatedStorage:FindFirstChild('rip_indra True Form') then
							if #game.Players:GetChildren() <= 9 and not table.find(_G.Keep_JobX,tostring(game.JobId)) then
								...
								SendBoss('https://discord.com/api/webhooks/1280329215111336008/Xk_d5pQd_KPjdxXpzUnYfWaAMxBxj2iBFCYd6JLNwK3UVQtrhZbVHY-YPNAB4GNi6Mh6','rip_indra True Form')
							end
						end
						if #game.Players:GetChildren() <= 3 then
							SendFullMoon('https://discord.com/api/webhooks/1280343498016428062/fUNR76kYjtq8X8gYs5DBmGzN7syhOArktkb_ImLlRcdey2Vf0OhRnn78ESfElF6hUFG-')
						end
						...
						if FullMoon_S and MysticIsland_S and not table.find(_G.Keep_Job,tostring(game.JobId)) and game:GetService("Lighting").LightingLayers.Night.Intensity.Value == 1 then
							...
							SendFullMoon('https://discord.com/api/webhooks/1280343291556270090/ePavTA3RlIz8YxXN5s2kVxEot-HpPmQxPMXGpBaUuscgVwCyrjXu_f4kvXwYFux7dvS_')
							return
						elseif FullMoon_S and not table.find(_G.Keep_Job,tostring(game.JobId)) and game:GetService("Lighting").LightingLayers.Night.Intensity.Value == 1 then
							table.insert(_G.Keep_Job,tostring(game.JobId))
							SendFullMoon('https://discord.com/api/webhooks/1280341986192261130/AZxDnzJnGaDeCGyMHKp-wFmu6M3CWPSUeteJM4A-O9oIA8zjebaevDx_ZeYsaQooRile')
							return
						elseif MysticIsland_S and not table.find(_G.Keep_Job,tostring(game.JobId)) then
							table.insert(_G.Keep_Job,tostring(game.JobId))
							SendFullMoon('https://discord.com/api/webhooks/1280342666021699647/i-V0nUtPxYUMblXr7RRXXxBoXnphXabUmBnaiRZm_8oN2lZIaSN1RwC75UGmkuIUns2k')
							return
						end	
						wait(10)
					end
				...
				pcall(function()
					if game.Workspace.Enemies:FindFirstChild('Cursed Captain') or game.ReplicatedStorage:FindFirstChild('Cursed Captain') then
						if #game.Players:GetChildren() <= 10 and not table.find(_G.Keep_JobX,tostring(game.JobId)) then
							table.insert(_G.Keep_JobX,tostring(game.JobId))
							SendBoss('https://discord.com/api/webhooks/1234917102838747167/gtpCJLEVvEsaXHQBnyNsOIweXbDQl6JN-nPAQR4N3moSLoiwp1mp3o9m1j5_-QSORVS9','Cursed Captain')
						end
					end
					if game.Workspace.Enemies:FindFirstChild('Darkbeard') or game.ReplicatedStorage:FindFirstChild('Darkbeard') then
						if #game.Players:GetChildren() <= 10 and not table.find(_G.Keep_JobX,tostring(game.JobId)) then
							table.insert(_G.Keep_JobX,tostring(game.JobId))
							SendBoss('https://discord.com/api/webhooks/1234917102838747167/gtpCJLEVvEsaXHQBnyNsOIweXbDQl6JN-nPAQR4N3moSLoiwp1mp3o9m1j5_-QSORVS9','Darkbeard')
						end
					end
				end)
			end
